...
-- 2022-02-22, DIyer, Created File for Assignment06
-- 2022-02-25, DIyer, updated based on reviewing assignment06
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_DIyer')
	 Begin 
	  Alter Database [Assignment06DB_DIyer] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_DIyer;
	 End
	Create Database Assignment06DB_DIyer;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_DIyer;
...
Create View vInventoriesByProductsByEmployeesByCategories
As
	Select Top 1000000
		C.CategoryName,
		P.ProductName,
